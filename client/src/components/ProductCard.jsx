                    ...
                    <div className="text-primary" onClick={(e) => { e.stopPropagation() }}>
                        {!cartItems[product._id] ? (
                            <button onClick={() => addToCart(product._id)}
                                className="flex items-center justify-center gap-1 bg-primary/15 border cursor-pointer border-primary/25 md:w-[80px] w-[64px] h-[34px] rounded text-primary font-medium">
